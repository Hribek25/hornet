...
replace github.com/iotaledger/hive.go => github.com/muxxer/hive.go v0.0.0-20210314001153-b2b064dfdf8f
...
require (
	...
	github.com/iotaledger/iota.go/v2 v2.0.0-20210311103028-90a8ef66bb7b
